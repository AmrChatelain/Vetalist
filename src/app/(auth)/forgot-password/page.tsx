  ...
  return (
    <>
      <style>{`
        ...
        /* confused cat illustration area */
        .cat-scene {
          display: flex;
          justify-content: center;
        ...
        .question-mark {
          ...
          right: -12px;
          font-size: 22px;
          animation: floatQ 2s ease-in-out infinite;
        }
        ...
        /* submit button — same kitty style */
        .submit-wrapper {
          display: flex;
          justify-content: center;
          margin-top: 1.5rem;
        ...
        <div className="fp-card">
          ...
          <div className="fp-header">
            ...
            <p className="fp-subtitle">
              Don't worry, even cats forget things.
              <br />
            ...
            <div className="cat-scene">
              <div className="confused-cat">
                ...
                <svg viewBox="0 0 80 80" width="80" height="80">
                  ...
                  {/* body */}
                  <path
                    d="M16 72C16 48 24 24 40 24C56 24 64 48 64 72"
                    fill="#fbbf24"
                  />
                  {/* ears */}
                  ...
                  {/* wavy mouth — confused */}
                  <path
                    d="M34 58 Q37 55 40 58 Q43 61 46 58"
                    stroke="#92400e"
                    strokeWidth="1.5"
                    fill="none"
                    strokeLinecap="round"
          ...
          {!sent ? (
                ...
                <button type="submit" className="kitty-btn" disabled={loading}>
                  ...
                  <div className="btn-body">
                    ...
                    <div className="btn-text">
                      <span className="btn-label">Send link</span>
            ...
            <div className="success-scene">
              ...
              <p className="success-title">Email is on its way!</p>
              <p className="success-text">
                Check your inbox for a reset link.
                <br />
                Our cat courier is very fast 🐱💨
              </p>
              <p className="success-note">
                Didn't get it? Check your spam folder — sometimes cats knock
                things off shelves 🙃
              </p>
            </div>
          )}
