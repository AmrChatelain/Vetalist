  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#f5f0fa", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <aside className="hidden md:flex" style={{
        width: 260, minHeight: "100vh", flexDirection: "column",
      ...
      {/* Main */}
      <main className="md:ml-[260px]" style={{ flex: 1, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{
          ...
          <span className="hidden sm:block" style={{ fontSize: "0.8rem", color: "#94a3b8" }}>
